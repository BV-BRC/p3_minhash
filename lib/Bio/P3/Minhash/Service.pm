package Bio::P3::Minhash::Service;
...
our %return_counts = (
        ...
        'compute_genome_distance_for_genome2' => 1,
        'compute_genome_distance_for_fasta2' => 1,
        'version' => 1,
);
...
our %method_authentication = (
        ...
        'compute_genome_distance_for_genome2' => 'optional',
        'compute_genome_distance_for_fasta2' => 'optional',
);
...
sub call_method {
    ...
    my $ctx = Bio::P3::Minhash::ServiceContext->new(client_ip => $self->getIPAddress());
    $ctx->module($modname);
    $ctx->method($method);
...
{
    # Service Minhash requires authentication.
	...
	{
	    $self->exception('PerlError', "Authentication required for Minhash but no authentication header was passed");
	}
	...
	my $stderr = Bio::P3::Minhash::ServiceStderrWrapper->new($ctx, $get_time);
	$ctx->stderr($stderr);
...
sub get_method
{
    ...
    {
	$self->exception('NoSuchMethod',
			 "'$method' is not a valid method in service Minhash.");
    }
...
package Bio::P3::Minhash::ServiceContext;

use strict;

=head1 NAME

Bio::P3::Minhash::ServiceContext
...
package Bio::P3::Minhash::ServiceStderrWrapper;
